...
public class ExceptionExercise4 {
  ...
  // Folloew the instructions below to complete the User Registration Process
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out
            .println("User Registration is Fail. Reason:" + e.getMessage());
    }
  ...
  // otherwise, print "User registered successfully; jackwong", where jackywong is the username.
  ...
  // Throw IllegalArgumentExcepton if String email is null or it does not contain character @
